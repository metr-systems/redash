    ...
    <div className="databricks-schema-browser schema-container" {...props}>
      <div className="schema-control">
        <Input
          ...
          placeholder={t("Filter tables & columns...")}
          aria-label={t("Search schema")}
          ...
          addonBefore={
            <Select
              ...
              placeholder={
                <>
                  <i className="fa fa-database m-r-5" aria-hidden="true" /> {t("Database")}
                </>
              }>
      ...
      <div className="schema-list-wrapper">
        ...
        {!(loadingSchema || loadingDatabases) && (
          <div className="load-button">
            <Tooltip title={!refreshing ? t("Refresh Databases and Current Schema") : null}>
