...
function saveVisualization(visualization) {
  ...
  return Visualization.save(visualization)
    .then(result => {
      notification.success(i18next.t("Visualization:Visualization saved"));
      return result;
    })
    .catch(error => {
      notification.error(i18next.t("Visualization:Visualization could not be saved"));
...
function confirmDialogClose(isDirty) {
  return new Promise((resolve, reject) => {
    if (isDirty) {
      Modal.confirm({
        title: i18next.t("Visualization:Visualization Editor"),
        content: i18next.t("Visualization:Are you sure you want to close the editor without saving?"),
      ...
      <div className="edit-visualization-dialog">
        <div className="visualization-settings">
          <div className="m-b-15">
            <label htmlFor={vizTypeId}>{i18next.t("Visualization:Visualization Type")}</label>
            <Select
          ...
          <div className="m-b-15">
            <label htmlFor={vizNameId}>{i18next.t("Visualization:Visualization Name")}</label>
            <Input
