      ...
      {!props.query.isNew() && (!props.query.is_draft || !props.query.is_archived) && (
        <Menu.Item>
          <PlainButton onClick={() => props.openAddToDashboardForm(props.selectedTab)}>
            <PlusCircleFilledIcon /> {t("Visualization:Add to Dashboard")}
          </PlainButton>
        </Menu.Item>
      )}
      {!clientConfig.disablePublicUrls && !props.query.isNew() && (
        <Menu.Item>
          <PlainButton
            ...
            <ShareAltOutlinedIcon /> {t("Visualization:Embed Elsewhere")}
          </PlainButton>
        </Menu.Item>
      )}
      <Menu.Item>
        <QueryResultsLink
          ...
          embed={props.embed}
          apiKey={props.apiKey}>
          <FileOutlinedIcon /> {t("Visualization:Download as CSV File")}
        </QueryResultsLink>
      </Menu.Item>
      <Menu.Item>
        <QueryResultsLink
          ...
          embed={props.embed}
          apiKey={props.apiKey}>
          <FileOutlinedIcon /> {t("Visualization:Download as TSV File")}
        </QueryResultsLink>
      </Menu.Item>
      <Menu.Item>
        <QueryResultsLink
          ...
          embed={props.embed}
          apiKey={props.apiKey}>
          <FileExcelOutlinedIcon /> {t("Visualization:Download as Excel File")}
        </QueryResultsLink>
      </Menu.Item>
    </Menu>
  );
