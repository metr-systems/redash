import { extractFixedFromUrlParameterNames } from "../../hooks/useFixedFromUrlParameters";

describe("Fixed From URL Parameters Integration", () => {
  describe("extractFixedFromUrlParameterNames", () => {
    test("should extract parameter names from simple widget mappings", () => {
      ...
      const result = extractFixedFromUrlParameterNames(dashboard);
    ...
    test("should handle empty or malformed dashboard", () => {
      expect(extractFixedFromUrlParameterNames(null)).toEqual([]);
      expect(extractFixedFromUrlParameterNames({})).toEqual([]);
      expect(extractFixedFromUrlParameterNames({ widgets: [] })).toEqual([]);
      expect(extractFixedFromUrlParameterNames({ widgets: null })).toEqual([]);
    });
