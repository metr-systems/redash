...
export default function FeatureFlagsSettings(props) {
  ...
  return (
    <DynamicComponent name="OrganizationSettings.FeatureFlagsSettings" {...props}>
      <Form.Item label={i18next.t("Settings:Feature Flags")}>
        {loading ? (
          <>
            <Row>
            ...
            <DynamicComponent name="OrganizationSettings.FeatureFlagsSettings.PermissionsControl" {...props}>
              <Row>
                <Checkbox
                  ...
                  {i18next.t("Settings:Enable experimental multiple owners support")}
                </Checkbox>
              </Row>
            </DynamicComponent>
            <Row>
              <Checkbox
                ...
                {i18next.t("Settings:Email query owners when scheduled queries fail")}
              </Checkbox>
            </Row>
            <Row>
              <Checkbox
                ...
                {i18next.t("Settings:Enable multi-byte (Chinese, Japanese, and Korean) search for query names and descriptions (slower)")}
              </Checkbox>
            </Row>
            <Row>
              <Checkbox
                ...
                {i18next.t("Settings:Enable auto-refresh when opening a dashboard page")}
              </Checkbox>
            </Row>
          </>
        )}
